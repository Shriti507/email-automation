    ...
    return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-violet-200 via-purple-50 to-indigo-100">
              <form onSubmit={handleSubmit} className="sm:w-[350px] w-full text-center border border-gray-300/60 rounded-2xl px-8 bg-white max-h-200 overflow-y-auto pb-4">
                  ...
                  <div className="flex items-center mt-6 w-full bg-white border border-gray-300 h-12 rounded-full overflow-hidden pl-6 gap-2 text-gray-600">
                  ...
                  <div className="flex items-center w-full mt-4 bg-white border border-gray-300/80 h-12 rounded-full overflow-hidden pl-6 gap-2 text-gray-600">
                  ...
                  <div className="flex items-center mt-4 w-full bg-white border border-gray-300/80 h-12 rounded-full overflow-hidden pl-6 gap-2 text-gray-600">
